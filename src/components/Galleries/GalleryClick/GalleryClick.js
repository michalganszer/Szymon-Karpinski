                    ...
                    <div className={styles.slideNav}>
                        <div className={styles.buttons}>
                            ...
                            <MediaQuery minWidth={900}> 
                                {(this.state.currentIndex != 0) ? <Prev goToPrevSlide={this.goToPrevSlide}/> : <span>&nbsp;</span>}
                                {(this.state.currentIndex != (this.state.slides.length - 1)) && <Next goToNextSlide={this.goToNextSlide}/> }
                            </MediaQuery> 
                            
                            &nbsp;</div>
                        <div className={styles.imageCounter}>{this.state.currentIndex+1}/{this.state.slides.length}</div>
...
const Info = ({ info, showInfo }) =>(
    <p className={showInfo ? styles.infoContentFadeIn : styles.infoContentFadeOut}>{info}</p>
)
